...
import { AuthenticatedRequest } from '../../middleware/auth.middleware.js'; // ✨ FIX: Reverted to standard auth middleware
...
export const getUserRecommendationsHandler = async (req: AuthenticatedRequest, res: Response) => {
  try {
