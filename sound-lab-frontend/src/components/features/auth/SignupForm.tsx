  ...
  const formElements = [
    ...
    <div key="username-group">
      ...
      <Input
        ...
        disabled={isLoading}
        className="mt-1 bg-gray-800/50 border-gray-700 text-white placeholder-gray-500 focus:ring-teal-500 focus:border-teal-500"
      />
    </div>,
    <div key="email-group">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            <Button
              ...
              fullWidth
              disabled={isLoading}
              // Enhanced button styling - using teal for distinction
              className="bg-teal-600 hover:bg-teal-700 text-white font-bold transition-all duration-300 ease-in-out transform hover:scale-105"
            >
