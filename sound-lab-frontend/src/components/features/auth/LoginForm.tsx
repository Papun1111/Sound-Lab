...
export const LoginForm = () => {
  ...
  return (
    ...
    <div className="min-h-screen w-full flex flex-col items-center justify-center bg-[#F3EFEA] p-4 font-sans">
        ...
        {/* Main form container, styled to match the new clean design. */}
        <motion.div
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <motion.div variants={itemVariants} className="text-center">
                    <p className="text-sm text-neutral-500">
                        ...
                        <Link href="/signup" className="font-bold text-[#212121] hover:underline">
                            Sign up here
                        </Link>
                    </p>
                </motion.div>
