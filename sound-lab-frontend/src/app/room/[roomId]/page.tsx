      ...
      {transitions((style, item) => item && (
        <animated.div style={style}>
          <header className="mx-auto max-w-screen-xl mb-4 flex justify-between items-center">
             <h1 className="text-2xl font-bold text-purple-400">Sound Lab Room</h1>
             <Link href="/" className="flex items-center gap-2 rounded-md bg-purple-600 px-3 py-2 text-sm text-white transition-colors hover:bg-purple-500">
               <FaHome />
               <span>Home</span>
             </Link>
          </header>
